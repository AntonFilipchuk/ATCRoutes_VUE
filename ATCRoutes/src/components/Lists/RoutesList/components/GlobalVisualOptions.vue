  ...
  <div class="global-show-container">
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="option">
          <button class="increase-decrease-button" @click="changeRouteLineWidth(2)">+</button>
          <button class="increase-decrease-button" @click="changeRouteLineWidth(-2)">-</button>
        </div>
      </div>
      <div class="row">
        ...
        <div class="option">
          <button class="increase-decrease-button" @click="changeRoutePointsWidth(2)">+</button>
          <button class="increase-decrease-button" @click="changeRoutePointsWidth(-2)">-</button>
        </div>
      </div>
      <div class="row">
        ...
        <div class="option">
          <button class="increase-decrease-button" @click="changeTextSize(2)">+</button>
          <button class="increase-decrease-button" @click="changeTextSize(-2)">-</button>
        </div>
      </div>
    </div>
